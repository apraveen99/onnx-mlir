...
// RUN: onnx-mlir-opt --shape-inference --decompose-onnx=enable-convtranspose-phased %s -split-input-file | FileCheck %s --check-prefix CHECK --check-prefix RTR
// RUN: onnx-mlir-opt --shape-inference --decompose-onnx="enable-convtranspose-phased enable-convtranspose-depthtospace" %s -split-input-file | FileCheck %s --check-prefix CHECK --check-prefix=D2S
...
// RTR-DAG:       [[VAR_0_:%.+]] = onnx.Constant dense<[1, 256, 20, 32]> : tensor<4xi64>
// RTR-DAG:       [[VAR_1_:%.+]] = onnx.Constant dense<[2, 2, 256, 10, 16]> : tensor<5xi64>
...
// CHECK-DAG:       [[VAR_16_:%.+]] = "onnx.Slice"([[VAR_15_]], [[VAR_6_]], {{%.+}}, [[VAR_8_]], [[VAR_7_]]) : (tensor<256x512x6x6xf32>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>) -> tensor<256x512x3x3xf32>
// CHECK-DAG:       [[VAR_17_:%.+]] = "onnx.Slice"([[VAR_15_]], [[VAR_4_]], {{%.+}}, [[VAR_8_]], [[VAR_7_]]) : (tensor<256x512x6x6xf32>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>) -> tensor<256x512x3x3xf32>
// CHECK-DAG:       [[VAR_18_:%.+]] = "onnx.Slice"([[VAR_15_]], [[VAR_3_]], {{%.+}}, [[VAR_8_]], [[VAR_7_]]) : (tensor<256x512x6x6xf32>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>) -> tensor<256x512x3x3xf32>
// CHECK-DAG:       [[VAR_19_:%.+]] = "onnx.Slice"([[VAR_15_]], [[VAR_2_]], {{%.+}}, [[VAR_8_]], [[VAR_7_]]) : (tensor<256x512x6x6xf32>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>) -> tensor<256x512x3x3xf32>
...
// RTR:           [[VAR_23_:%.+]] = "onnx.Reshape"([[VAR_22_]], [[VAR_1_]]) {allowzero = 0 : si64} : (tensor<1x1024x10x16xf32>, tensor<5xi64>) -> tensor<2x2x256x10x16xf32>
// RTR:           [[VAR_24_:%.+]] = "onnx.Transpose"([[VAR_23_]]) {perm = [2, 3, 0, 4, 1]} : (tensor<2x2x256x10x16xf32>) -> tensor<256x10x2x16x2xf32>
// RTR:           [[VAR_26_:%.+]] = "onnx.Reshape"([[VAR_24_]], [[VAR_0_]]) {allowzero = 0 : si64} : (tensor<256x10x2x16x2xf32>, tensor<4xi64>) -> tensor<1x256x20x32xf32>
// D2S:           [[VAR_26_:%.+]] = "onnx.DepthToSpace"([[VAR_22_]]) {blocksize = 2 : si64, mode = "DCR"} : (tensor<1x1024x10x16xf32>) -> tensor<1x256x20x32xf32>
...
// RTR:           [[VAR_22_:%.+]] = "onnx.Reshape"([[VAR_21_]], [[VAR_1_]]) {allowzero = 0 : si64} : (tensor<1x1024x10x16xf32>, tensor<5xi64>) -> tensor<2x2x256x10x16xf32>
// RTR:           [[VAR_23_:%.+]] = "onnx.Transpose"([[VAR_22_]]) {perm = [2, 3, 0, 4, 1]} : (tensor<2x2x256x10x16xf32>) -> tensor<256x10x2x16x2xf32>
// RTR:           [[VAR_25_:%.+]] = "onnx.Reshape"([[VAR_23_]], [[VAR_0_]]) {allowzero = 0 : si64} : (tensor<256x10x2x16x2xf32>, tensor<4xi64>) -> tensor<1x256x20x32xf32>
// D2S:           [[VAR_25_:%.+]] = "onnx.DepthToSpace"([[VAR_21_]]) {blocksize = 2 : si64, mode = "DCR"} : (tensor<1x1024x10x16xf32>) -> tensor<1x256x20x32xf32>
...
// CHECK-SAME:   ([[PARAM_0_:%.+]]: tensor<1x1x12x44xf32>, [[PARAM_1_:%.+]]: tensor<1x1x4x16xf32>) -> tensor<1x1x13x57xf32> {
// CHECK-DAG:       [[VAR_0_:%.+]] = onnx.Constant dense<16> : tensor<4xi64>
// CHECK-DAG:       [[VAR_1_:%.+]] = onnx.Constant dense<4> : tensor<16xi64>
// CHECK-DAG:       [[VAR_2_:%.+]] = onnx.Constant dense<2.000000e-02> : tensor<1xf32>
// CHECK-DAG:       [[VAR_3_:%.+]] = "onnx.Transpose"([[PARAM_1_]]) {perm = [2, 3, 0, 1]} : (tensor<1x1x4x16xf32>) -> tensor<4x16x1x1xf32>
// CHECK:           [[VAR_4_:%.+]] = "onnx.ReverseSequence"([[VAR_3_]], [[VAR_1_]]) {batch_axis = 1 : si64, time_axis = 0 : si64} : (tensor<4x16x1x1xf32>, tensor<16xi64>) -> tensor<4x16x1x1xf32>
// CHECK:           [[VAR_5_:%.+]] = "onnx.ReverseSequence"([[VAR_4_]], [[VAR_0_]]) {batch_axis = 0 : si64, time_axis = 1 : si64} : (tensor<4x16x1x1xf32>, tensor<4xi64>) -> tensor<4x16x1x1xf32>
// CHECK:           [[VAR_6_:%.+]] = "onnx.Transpose"([[VAR_5_]]) {perm = [2, 3, 0, 1]} : (tensor<4x16x1x1xf32>) -> tensor<1x1x4x16xf32>
// CHECK:           [[VAR_7_:%.+]] = "onnx.Transpose"([[VAR_6_]]) {perm = [1, 0, 2, 3]} : (tensor<1x1x4x16xf32>) -> tensor<1x1x4x16xf32>
// CHECK:           [[VAR_8_:%.+]] = "onnx.Conv"([[PARAM_0_]], [[VAR_7_]], [[VAR_2_]]) {auto_pad = "NOTSET", dilations = [1, 1], group = 1 : si64, kernel_shape = [4, 16], pads = [2, 14, 2, 14], strides = [1, 1]} : (tensor<1x1x12x44xf32>, tensor<1x1x4x16xf32>, tensor<1xf32>) -> tensor<1x1x13x57xf32>
// CHECK:           onnx.Return [[VAR_8_]] : tensor<1x1x13x57xf32>
// CHECK:         }
}
...
// CHECK-SAME:   ([[PARAM_0_:%.+]]: tensor<1x1x12x44xf32>, [[PARAM_1_:%.+]]: tensor<1x1x4x16xf32>) -> tensor<1x1x14x58xf32> {
// CHECK-DAG:       [[VAR_0_:%.+]] = onnx.Constant dense<16> : tensor<4xi64>
// CHECK-DAG:       [[VAR_1_:%.+]] = onnx.Constant dense<4> : tensor<16xi64>
// CHECK-DAG:       [[VAR_2_:%.+]] = onnx.Constant dense<2.000000e-02> : tensor<1xf32>
// CHECK-DAG:       [[VAR_3_:%.+]] = "onnx.Transpose"([[PARAM_1_]]) {perm = [2, 3, 0, 1]} : (tensor<1x1x4x16xf32>) -> tensor<4x16x1x1xf32>
...
// CHECK:           [[VAR_6_:%.+]] = "onnx.Transpose"([[VAR_5_]]) {perm = [2, 3, 0, 1]} : (tensor<4x16x1x1xf32>) -> tensor<1x1x4x16xf32>
// CHECK:           [[VAR_7_:%.+]] = "onnx.Transpose"([[VAR_6_]]) {perm = [1, 0, 2, 3]} : (tensor<1x1x4x16xf32>) -> tensor<1x1x4x16xf32>
// CHECK:           [[VAR_8_:%.+]] = "onnx.Conv"([[PARAM_0_]], [[VAR_7_]], [[VAR_2_]]) {auto_pad = "NOTSET", dilations = [1, 1], group = 1 : si64, kernel_shape = [4, 16], pads = [2, 14, 3, 15], strides = [1, 1]} : (tensor<1x1x12x44xf32>, tensor<1x1x4x16xf32>, tensor<1xf32>) -> tensor<1x1x14x58xf32>
// CHECK:           onnx.Return [[VAR_8_]] : tensor<1x1x14x58xf32>
// CHECK:         }
}
...
// CHECK-SAME:   ([[PARAM_0_:%.+]]: tensor<1x1x12x44xf32>, [[PARAM_1_:%.+]]: tensor<1x1x4x16xf32>) -> tensor<1x1x14x59xf32> {
// CHECK-DAG:       [[VAR_0_:%.+]] = onnx.Constant dense<16> : tensor<4xi64>
// CHECK-DAG:       [[VAR_1_:%.+]] = onnx.Constant dense<4> : tensor<16xi64>
// CHECK-DAG:       [[VAR_2_:%.+]] = onnx.Constant dense<2.000000e-02> : tensor<1xf32>
// CHECK-DAG:       [[VAR_3_:%.+]] = "onnx.Transpose"([[PARAM_1_]]) {perm = [2, 3, 0, 1]} : (tensor<1x1x4x16xf32>) -> tensor<4x16x1x1xf32>
...
// CHECK:           [[VAR_6_:%.+]] = "onnx.Transpose"([[VAR_5_]]) {perm = [2, 3, 0, 1]} : (tensor<4x16x1x1xf32>) -> tensor<1x1x4x16xf32>
// CHECK:           [[VAR_7_:%.+]] = "onnx.Transpose"([[VAR_6_]]) {perm = [1, 0, 2, 3]} : (tensor<1x1x4x16xf32>) -> tensor<1x1x4x16xf32>
// CHECK:           [[VAR_8_:%.+]] = "onnx.Conv"([[PARAM_0_]], [[VAR_7_]], [[VAR_2_]]) {auto_pad = "NOTSET", dilations = [1, 1], group = 1 : si64, kernel_shape = [4, 16], pads = [2, 15, 3, 15], strides = [1, 1]} : (tensor<1x1x12x44xf32>, tensor<1x1x4x16xf32>, tensor<1xf32>) -> tensor<1x1x14x59xf32>
// CHECK:           onnx.Return [[VAR_8_]] : tensor<1x1x14x59xf32>
// CHECK:         }
}
...
// CHECK-SAME:   ([[PARAM_0_:%.+]]: tensor<1x1x12x44xf32>, [[PARAM_1_:%.+]]: tensor<1x1x4x16xf32>) -> tensor<1x1x13x59xf32> {
// CHECK-DAG:       [[VAR_0_:%.+]] = onnx.Constant dense<16> : tensor<4xi64>
// CHECK-DAG:       [[VAR_1_:%.+]] = onnx.Constant dense<4> : tensor<16xi64>
// CHECK-DAG:       [[VAR_2_:%.+]] = onnx.Constant dense<2.000000e-02> : tensor<1xf32>
// CHECK-DAG:       [[VAR_3_:%.+]] = "onnx.Transpose"([[PARAM_1_]]) {perm = [2, 3, 0, 1]} : (tensor<1x1x4x16xf32>) -> tensor<4x16x1x1xf32>
...
// CHECK:           [[VAR_6_:%.+]] = "onnx.Transpose"([[VAR_5_]]) {perm = [2, 3, 0, 1]} : (tensor<4x16x1x1xf32>) -> tensor<1x1x4x16xf32>
// CHECK:           [[VAR_7_:%.+]] = "onnx.Transpose"([[VAR_6_]]) {perm = [1, 0, 2, 3]} : (tensor<1x1x4x16xf32>) -> tensor<1x1x4x16xf32>
// CHECK:           [[VAR_8_:%.+]] = "onnx.Conv"([[PARAM_0_]], [[VAR_7_]], [[VAR_2_]]) {auto_pad = "NOTSET", dilations = [1, 1], group = 1 : si64, kernel_shape = [4, 16], pads = [2, 15, 2, 15], strides = [1, 1]} : (tensor<1x1x12x44xf32>, tensor<1x1x4x16xf32>, tensor<1xf32>) -> tensor<1x1x13x59xf32>
// CHECK:           onnx.Return [[VAR_8_]] : tensor<1x1x13x59xf32>
// CHECK:         }
}
...
// CHECK-SAME:   ([[PARAM_0_:%.+]]: tensor<1x1x27x110xf32>, [[PARAM_1_:%.+]]: tensor<1x1x2x8xf32>) -> tensor<1x1x28x117xf32> {
// CHECK-DAG:       [[VAR_0_:%.+]] = onnx.Constant dense<8> : tensor<2xi64>
// CHECK-DAG:       [[VAR_1_:%.+]] = onnx.Constant dense<2> : tensor<8xi64>
// CHECK-DAG:       [[VAR_2_:%.+]] = onnx.Constant dense<2.000000e-02> : tensor<1xf32>
// CHECK-DAG:       [[VAR_3_:%.+]] = "onnx.Transpose"([[PARAM_1_]]) {perm = [2, 3, 0, 1]} : (tensor<1x1x2x8xf32>) -> tensor<2x8x1x1xf32>
// CHECK:           [[VAR_4_:%.+]] = "onnx.ReverseSequence"([[VAR_3_]], [[VAR_1_]]) {batch_axis = 1 : si64, time_axis = 0 : si64} : (tensor<2x8x1x1xf32>, tensor<8xi64>) -> tensor<2x8x1x1xf32>
// CHECK:           [[VAR_5_:%.+]] = "onnx.ReverseSequence"([[VAR_4_]], [[VAR_0_]]) {batch_axis = 0 : si64, time_axis = 1 : si64} : (tensor<2x8x1x1xf32>, tensor<2xi64>) -> tensor<2x8x1x1xf32>
// CHECK:           [[VAR_6_:%.+]] = "onnx.Transpose"([[VAR_5_]]) {perm = [2, 3, 0, 1]} : (tensor<2x8x1x1xf32>) -> tensor<1x1x2x8xf32>
// CHECK:           [[VAR_7_:%.+]] = "onnx.Transpose"([[VAR_6_]]) {perm = [1, 0, 2, 3]} : (tensor<1x1x2x8xf32>) -> tensor<1x1x2x8xf32>
// CHECK:           [[VAR_8_:%.+]] = "onnx.Conv"([[PARAM_0_]], [[VAR_7_]], [[VAR_2_]]) {auto_pad = "NOTSET", dilations = [1, 1], group = 1 : si64, kernel_shape = [2, 8], pads = [1, 7, 1, 7], strides = [1, 1]} : (tensor<1x1x27x110xf32>, tensor<1x1x2x8xf32>, tensor<1xf32>) -> tensor<1x1x28x117xf32>
// CHECK:           onnx.Return [[VAR_8_]] : tensor<1x1x28x117xf32>
// CHECK:         }
}
...
// RTR-DAG:       [[VAR_0_:%.+]] = onnx.Constant dense<[1, 1, 54, 222]> : tensor<4xi64>
// RTR-DAG:       [[VAR_1_:%.+]] = onnx.Constant dense<[1, 1, 18, 1, 222]> : tensor<5xi64>
// RTR-DAG:       [[VAR_2_:%.+]] = onnx.Constant dense<[1, 1, 18, 74, 1]> : tensor<5xi64>
...
// CHECK-DAG:       [[VAR_21_:%.+]] = "onnx.Slice"([[VAR_20_]], [[VAR_11_]], {{%.+}}, [[VAR_13_]], [[VAR_12_]]) : (tensor<1x1x3x3xf32>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>) -> tensor<1x1x1x1xf32>
// CHECK-DAG:       [[VAR_22_:%.+]] = "onnx.Slice"([[VAR_20_]], [[VAR_10_]], {{%.+}}, [[VAR_13_]], [[VAR_12_]]) : (tensor<1x1x3x3xf32>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>) -> tensor<1x1x1x1xf32>
// CHECK-DAG:       [[VAR_23_:%.+]] = "onnx.Slice"([[VAR_20_]], [[VAR_9_]], {{%.+}}, [[VAR_13_]], [[VAR_12_]]) : (tensor<1x1x3x3xf32>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>) -> tensor<1x1x1x1xf32>
// CHECK-DAG:       [[VAR_24_:%.+]] = "onnx.Slice"([[VAR_20_]], [[VAR_8_]], {{%.+}}, [[VAR_13_]], [[VAR_12_]]) : (tensor<1x1x3x3xf32>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>) -> tensor<1x1x1x1xf32>
// CHECK-DAG:       [[VAR_25_:%.+]] = "onnx.Slice"([[VAR_20_]], [[VAR_7_]], {{%.+}}, [[VAR_13_]], [[VAR_12_]]) : (tensor<1x1x3x3xf32>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>) -> tensor<1x1x1x1xf32>
// CHECK-DAG:       [[VAR_26_:%.+]] = "onnx.Slice"([[VAR_20_]], [[VAR_6_]], {{%.+}}, [[VAR_13_]], [[VAR_12_]]) : (tensor<1x1x3x3xf32>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>) -> tensor<1x1x1x1xf32>
// CHECK-DAG:       [[VAR_27_:%.+]] = "onnx.Slice"([[VAR_20_]], [[VAR_5_]], {{%.+}}, [[VAR_13_]], [[VAR_12_]]) : (tensor<1x1x3x3xf32>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>) -> tensor<1x1x1x1xf32>
// CHECK-DAG:       [[VAR_28_:%.+]] = "onnx.Slice"([[VAR_20_]], [[VAR_4_]], {{%.+}}, [[VAR_13_]], [[VAR_12_]]) : (tensor<1x1x3x3xf32>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>) -> tensor<1x1x1x1xf32>
// CHECK-DAG:       [[VAR_29_:%.+]] = "onnx.Slice"([[VAR_20_]], [[VAR_3_]], {{%.+}}, [[VAR_13_]], [[VAR_12_]]) : (tensor<1x1x3x3xf32>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>) -> tensor<1x1x1x1xf32>
// CHECK-NOT: separator of consecutive DAGs
...
// RTR-NOT: separator of consecutive DAGs
// RTR-DAG:       [[VAR_39_:%.+]] = "onnx.Reshape"([[VAR_30_]], [[VAR_2_]]) {allowzero = 0 : si64} : (tensor<1x1x18x74xf32>, tensor<5xi64>) -> tensor<1x1x18x74x1xf32>
// RTR-DAG:       [[VAR_40_:%.+]] = "onnx.Reshape"([[VAR_31_]], [[VAR_2_]]) {allowzero = 0 : si64} : (tensor<1x1x18x74xf32>, tensor<5xi64>) -> tensor<1x1x18x74x1xf32>
// RTR-DAG:       [[VAR_41_:%.+]] = "onnx.Reshape"([[VAR_32_]], [[VAR_2_]]) {allowzero = 0 : si64} : (tensor<1x1x18x74xf32>, tensor<5xi64>) -> tensor<1x1x18x74x1xf32>
// RTR-DAG:       [[VAR_42_:%.+]] = "onnx.Reshape"([[VAR_33_]], [[VAR_2_]]) {allowzero = 0 : si64} : (tensor<1x1x18x74xf32>, tensor<5xi64>) -> tensor<1x1x18x74x1xf32>
// RTR-DAG:       [[VAR_43_:%.+]] = "onnx.Reshape"([[VAR_34_]], [[VAR_2_]]) {allowzero = 0 : si64} : (tensor<1x1x18x74xf32>, tensor<5xi64>) -> tensor<1x1x18x74x1xf32>
// RTR-DAG:       [[VAR_44_:%.+]] = "onnx.Reshape"([[VAR_35_]], [[VAR_2_]]) {allowzero = 0 : si64} : (tensor<1x1x18x74xf32>, tensor<5xi64>) -> tensor<1x1x18x74x1xf32>
// RTR-DAG:       [[VAR_45_:%.+]] = "onnx.Reshape"([[VAR_36_]], [[VAR_2_]]) {allowzero = 0 : si64} : (tensor<1x1x18x74xf32>, tensor<5xi64>) -> tensor<1x1x18x74x1xf32>
// RTR-DAG:       [[VAR_46_:%.+]] = "onnx.Reshape"([[VAR_37_]], [[VAR_2_]]) {allowzero = 0 : si64} : (tensor<1x1x18x74xf32>, tensor<5xi64>) -> tensor<1x1x18x74x1xf32>
// RTR-DAG:       [[VAR_47_:%.+]] = "onnx.Reshape"([[VAR_38_]], [[VAR_2_]]) {allowzero = 0 : si64} : (tensor<1x1x18x74xf32>, tensor<5xi64>) -> tensor<1x1x18x74x1xf32>
// RTR-NOT: separator of consecutive DAGs
// RTR-DAG:       [[VAR_48_:%.+]] = "onnx.Concat"([[VAR_39_]], [[VAR_40_]], [[VAR_45_]]) {axis = -1 : si64} : (tensor<1x1x18x74x1xf32>, tensor<1x1x18x74x1xf32>, tensor<1x1x18x74x1xf32>) -> tensor<1x1x18x74x3xf32>
// RTR-DAG:       [[VAR_49_:%.+]] = "onnx.Concat"([[VAR_42_]], [[VAR_43_]], [[VAR_44_]]) {axis = -1 : si64} : (tensor<1x1x18x74x1xf32>, tensor<1x1x18x74x1xf32>, tensor<1x1x18x74x1xf32>) -> tensor<1x1x18x74x3xf32>
// RTR-DAG:       [[VAR_50_:%.+]] = "onnx.Concat"([[VAR_41_]], [[VAR_46_]], [[VAR_47_]]) {axis = -1 : si64} : (tensor<1x1x18x74x1xf32>, tensor<1x1x18x74x1xf32>, tensor<1x1x18x74x1xf32>) -> tensor<1x1x18x74x3xf32>
// RTR-NOT: separator of consecutive DAGs
// RTR-DAG:       [[VAR_51_:%.+]] = "onnx.Reshape"([[VAR_48_]], [[VAR_1_]]) {allowzero = 0 : si64} : (tensor<1x1x18x74x3xf32>, tensor<5xi64>) -> tensor<1x1x18x1x222xf32>
// RTR-DAG:       [[VAR_52_:%.+]] = "onnx.Reshape"([[VAR_49_]], [[VAR_1_]]) {allowzero = 0 : si64} : (tensor<1x1x18x74x3xf32>, tensor<5xi64>) -> tensor<1x1x18x1x222xf32>
// RTR-DAG:       [[VAR_53_:%.+]] = "onnx.Reshape"([[VAR_50_]], [[VAR_1_]]) {allowzero = 0 : si64} : (tensor<1x1x18x74x3xf32>, tensor<5xi64>) -> tensor<1x1x18x1x222xf32>
// RTR:           [[VAR_54_:%.+]] = "onnx.Concat"([[VAR_51_]], [[VAR_52_]], [[VAR_53_]]) {axis = -2 : si64} : (tensor<1x1x18x1x222xf32>, tensor<1x1x18x1x222xf32>, tensor<1x1x18x1x222xf32>) -> tensor<1x1x18x3x222xf32>
// RTR:           [[VAR_55_:%.+]] = "onnx.Reshape"([[VAR_54_]], [[VAR_0_]]) {allowzero = 0 : si64} : (tensor<1x1x18x3x222xf32>, tensor<4xi64>) -> tensor<1x1x54x222xf32>
// D2S:           [[VAR_57_:%.+]] = "onnx.Concat"([[VAR_30_]], [[VAR_31_]], [[VAR_36_]], [[VAR_33_]], [[VAR_34_]], [[VAR_35_]], [[VAR_32_]], [[VAR_37_]], [[VAR_38_]]) {axis = 1 : si64} : (tensor<1x1x18x74xf32>, tensor<1x1x18x74xf32>, tensor<1x1x18x74xf32>, tensor<1x1x18x74xf32>, tensor<1x1x18x74xf32>, tensor<1x1x18x74xf32>, tensor<1x1x18x74xf32>, tensor<1x1x18x74xf32>, tensor<1x1x18x74xf32>) -> tensor<1x9x18x74xf32>
// D2S:           [[VAR_58_:%.+]] = "onnx.DepthToSpace"([[VAR_57_]]) {blocksize = 3 : si64, mode = "DCR"} : (tensor<1x9x18x74xf32>) -> tensor<1x1x54x222xf32>
// RTR:           onnx.Return [[VAR_55_]] : tensor<1x1x54x222xf32>
// D2S:           onnx.Return [[VAR_58_]] : tensor<1x1x54x222xf32>
// CHECK:         }
}
...
// RTR-DAG:       [[VAR_0_:%.+]] = onnx.Constant dense<[1, 32, 20, 32]> : tensor<4xi64>
// RTR-DAG:       [[VAR_1_:%.+]] = onnx.Constant dense<[2, 2, 32, 10, 16]> : tensor<5xi64>
// CHECK-DAG:       [[VAR_2_:%.+]] = onnx.Constant dense<1> : tensor<2xi64>
// CHECK-DAG:       [[VAR_3_:%.+]] = onnx.Constant dense<[0, 1]> : tensor<2xi64>
// CHECK-DAG:       [[VAR_4_:%.+]] = onnx.Constant dense<[1, 0]> : tensor<2xi64>
...
// CHECK-DAG:       [[VAR_20_:%.+]] = "onnx.Slice"([[VAR_19_]], [[VAR_6_]], {{%.+}}, [[VAR_8_]], [[VAR_7_]]) : (tensor<32x128x4x4xf32>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>) -> tensor<32x128x2x2xf32>
// CHECK-DAG:       [[VAR_21_:%.+]] = "onnx.Slice"([[VAR_19_]], [[VAR_4_]], {{%.+}}, [[VAR_8_]], [[VAR_7_]]) : (tensor<32x128x4x4xf32>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>) -> tensor<32x128x2x2xf32>
// CHECK-DAG:       [[VAR_22_:%.+]] = "onnx.Slice"([[VAR_19_]], [[VAR_3_]], {{%.+}}, [[VAR_8_]], [[VAR_7_]]) : (tensor<32x128x4x4xf32>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>) -> tensor<32x128x2x2xf32>
// CHECK-DAG:       [[VAR_23_:%.+]] = "onnx.Slice"([[VAR_19_]], [[VAR_2_]], {{%.+}}, [[VAR_8_]], [[VAR_7_]]) : (tensor<32x128x4x4xf32>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>) -> tensor<32x128x2x2xf32>
// CHECK-NOT: separator of consecutive DAGs
...
// RTR:           [[VAR_29_:%.+]] = "onnx.Reshape"([[VAR_28_]], [[VAR_1_]]) {allowzero = 0 : si64} : (tensor<1x128x10x16xf32>, tensor<5xi64>) -> tensor<2x2x32x10x16xf32>
// RTR:           [[VAR_30_:%.+]] = "onnx.Transpose"([[VAR_29_]]) {perm = [2, 3, 0, 4, 1]} : (tensor<2x2x32x10x16xf32>) -> tensor<32x10x2x16x2xf32>
// RTR:           [[VAR_31_:%.+]] = "onnx.Reshape"([[VAR_30_]], [[VAR_0_]]) {allowzero = 0 : si64} : (tensor<32x10x2x16x2xf32>, tensor<4xi64>) -> tensor<1x32x20x32xf32>
// D2S:           [[VAR_32_:%.+]] = "onnx.DepthToSpace"([[VAR_28_]]) {blocksize = 2 : si64, mode = "DCR"} : (tensor<1x128x10x16xf32>) -> tensor<1x32x20x32xf32>
// RTR:           onnx.Return [[VAR_31_]] : tensor<1x32x20x32xf32>
// D2S:           onnx.Return [[VAR_32_]] : tensor<1x32x20x32xf32>
// CHECK:         }
}
...
// CHECK-SAME:   ([[PARAM_0_:%.+]]: tensor<1x512x10x16xf32>, [[PARAM_1_:%.+]]: tensor<512x256x6x6xf32>) -> tensor<1x256x25x37xf32> {
// CHECK:           [[VAR_0_:%.+]] = onnx.Constant dense<2.000000e-02> : tensor<256xf32>
// CHECK:           [[VAR_1_:%.+]] = "onnx.ConvTranspose"([[PARAM_0_]], [[PARAM_1_]], [[VAR_0_]]) {auto_pad = "NOTSET", dilations = [2, 2], group = 1 : si64, kernel_shape = [6, 6], onnx_node_name = "share_proto/decoder_deconv_os16_deconv/BiasAdd", pads = [2, 2, 2, 2], strides = [2, 2]} : (tensor<1x512x10x16xf32>, tensor<512x256x6x6xf32>, tensor<256xf32>) -> tensor<1x256x25x37xf32>
// CHECK:           onnx.Return [[VAR_1_]] : tensor<1x256x25x37xf32>
// CHECK:         }
}
...
// CHECK:           [[VAR_6_:%.+]] = "onnx.Transpose"([[VAR_5_]]) {perm = [2, 3, 0, 1]} : (tensor<2x8x1x1xf32>) -> tensor<1x1x2x8xf32>
// CHECK:           [[VAR_7_:%.+]] = "onnx.Transpose"([[VAR_6_]]) {perm = [1, 0, 2, 3]} : (tensor<1x1x2x8xf32>) -> tensor<1x1x2x8xf32>
// CHECK:           [[VAR_8_:%.+]] = "onnx.Conv"([[PARAM_0_]], [[VAR_7_]], [[VAR_2_]]) {auto_pad = "NOTSET", group = 1 : si64, kernel_shape = [2, 8], pads = [1, 7, 1, 7], strides = [1, 1]} : (tensor<1x1x27x110xf32>, tensor<1x1x2x8xf32>, tensor<1xf32>) -> tensor<1x1x28x117xf32>
// CHECK:           onnx.Return [[VAR_8_]] : tensor<1x1x28x117xf32>
// CHECK:         }
}
...
// RTR-DAG:       [[VAR_0_:%.+]] = onnx.Constant dense<[1, 240, 16, 192]> : tensor<4xi64>
// RTR-DAG:       [[VAR_1_:%.+]] = onnx.Constant dense<[2, 2, 240, 8, 96]> : tensor<5xi64>
// CHECK-DAG:       [[VAR_2_:%.+]] = onnx.Constant dense<1> : tensor<2xi64>
// CHECK-DAG:       [[VAR_3_:%.+]] = onnx.Constant dense<[0, 1]> : tensor<2xi64>
// CHECK-DAG:       [[VAR_4_:%.+]] = onnx.Constant dense<[1, 0]> : tensor<2xi64>
...
// CHECK-DAG:       [[VAR_14_:%.+]] = "onnx.Slice"([[VAR_13_]], [[VAR_5_]], {{%.+}}, [[VAR_6_]], [[VAR_7_]]) : (tensor<240x288x2x2xf32>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>) -> tensor<240x288x1x1xf32>
// CHECK-DAG:       [[VAR_15_:%.+]] = "onnx.Slice"([[VAR_13_]], [[VAR_4_]], {{%.+}}, [[VAR_6_]], [[VAR_7_]]) : (tensor<240x288x2x2xf32>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>) -> tensor<240x288x1x1xf32>
// CHECK-DAG:       [[VAR_16_:%.+]] = "onnx.Slice"([[VAR_13_]], [[VAR_3_]], {{%.+}}, [[VAR_6_]], [[VAR_7_]]) : (tensor<240x288x2x2xf32>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>) -> tensor<240x288x1x1xf32>
// CHECK-DAG:       [[VAR_17_:%.+]] = "onnx.Slice"([[VAR_13_]], [[VAR_2_]], {{%.+}}, [[VAR_6_]], [[VAR_7_]]) : (tensor<240x288x2x2xf32>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>) -> tensor<240x288x1x1xf32>
// CHECK-NOT: separator of consecutive DAGs
...
// RTR:           [[VAR_21_:%.+]] = "onnx.Reshape"([[VAR_20_]], [[VAR_1_]]) {allowzero = 0 : si64} : (tensor<1x960x8x96xf32>, tensor<5xi64>) -> tensor<2x2x240x8x96xf32>
// RTR:           [[VAR_22_:%.+]] = "onnx.Transpose"([[VAR_21_]]) {perm = [2, 3, 0, 4, 1]} : (tensor<2x2x240x8x96xf32>) -> tensor<240x8x2x96x2xf32>
// RTR:           [[VAR_23_:%.+]] = "onnx.Reshape"([[VAR_22_]], [[VAR_0_]]) {allowzero = 0 : si64} : (tensor<240x8x2x96x2xf32>, tensor<4xi64>) -> tensor<1x240x16x192xf32>
// D2S:           [[VAR_24_:%.+]] = "onnx.DepthToSpace"([[VAR_20_]]) {blocksize = 2 : si64, mode = "DCR"} : (tensor<1x960x8x96xf32>) -> tensor<1x240x16x192xf32>
// RTR:           onnx.Return [[VAR_23_]] : tensor<1x240x16x192xf32>
// D2S:           onnx.Return [[VAR_24_]] : tensor<1x240x16x192xf32>
// CHECK:         }
}
...
// RTR-DAG:       [[VAR_0_:%.+]] = onnx.Constant dense<[1, 512, 16, 16]> : tensor<4xi64>
// RTR-DAG:       [[VAR_1_:%.+]] = onnx.Constant dense<[2, 2, 512, 8, 8]> : tensor<5xi64>
// CHECK-DAG:       [[VAR_2_:%.+]] = onnx.Constant dense<1> : tensor<2xi64>
// CHECK-DAG:       [[VAR_3_:%.+]] = onnx.Constant dense<[0, 1]> : tensor<2xi64>
// CHECK-DAG:       [[VAR_4_:%.+]] = onnx.Constant dense<[1, 0]> : tensor<2xi64>
// CHECK-DAG:       [[VAR_5_:%.+]] = onnx.Constant dense<4> : tensor<2xi64>
...
// CHECK-DAG:       [[VAR_16_:%.+]] = "onnx.Slice"([[VAR_15_]], [[VAR_6_]], {{%.+}}, [[VAR_8_]], [[VAR_7_]]) : (tensor<512x512x4x4xf32>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>) -> tensor<512x512x2x2xf32>
// CHECK-DAG:       [[VAR_17_:%.+]] = "onnx.Slice"([[VAR_15_]], [[VAR_4_]], {{%.+}}, [[VAR_8_]], [[VAR_7_]]) : (tensor<512x512x4x4xf32>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>) -> tensor<512x512x2x2xf32>
// CHECK-DAG:       [[VAR_18_:%.+]] = "onnx.Slice"([[VAR_15_]], [[VAR_3_]], {{%.+}}, [[VAR_8_]], [[VAR_7_]]) : (tensor<512x512x4x4xf32>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>) -> tensor<512x512x2x2xf32>
// CHECK-DAG:       [[VAR_19_:%.+]] = "onnx.Slice"([[VAR_15_]], [[VAR_2_]], {{%.+}}, [[VAR_8_]], [[VAR_7_]]) : (tensor<512x512x4x4xf32>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>) -> tensor<512x512x2x2xf32>
// CHECK-NOT: separator of consecutive DAGs
...
// RTR:           [[VAR_25_:%.+]] = "onnx.Reshape"([[VAR_24_]], [[VAR_1_]]) {allowzero = 0 : si64} : (tensor<1x2048x8x8xf32>, tensor<5xi64>) -> tensor<2x2x512x8x8xf32>
// RTR:           [[VAR_26_:%.+]] = "onnx.Transpose"([[VAR_25_]]) {perm = [2, 3, 0, 4, 1]} : (tensor<2x2x512x8x8xf32>) -> tensor<512x8x2x8x2xf32>
// RTR:           [[VAR_27_:%.+]] = "onnx.Reshape"([[VAR_26_]], [[VAR_0_]]) {allowzero = 0 : si64} : (tensor<512x8x2x8x2xf32>, tensor<4xi64>) -> tensor<1x512x16x16xf32>
// D2S:           [[VAR_28_:%.+]] = "onnx.DepthToSpace"([[VAR_24_]]) {blocksize = 2 : si64, mode = "DCR"} : (tensor<1x2048x8x8xf32>) -> tensor<1x512x16x16xf32>
// RTR:           onnx.Return [[VAR_27_]] : tensor<1x512x16x16xf32>
// D2S:           onnx.Return [[VAR_28_]] : tensor<1x512x16x16xf32>
// CHECK:         }
}
...
// RTR:           [[VAR_24_:%.+]] = "onnx.Reshape"([[VAR_23_]], [[VAR_1_]]) {allowzero = 0 : si64} : (tensor<1x1024x10x16xf32>, tensor<5xi64>) -> tensor<2x2x256x10x16xf32>
// RTR:           [[VAR_25_:%.+]] = "onnx.Transpose"([[VAR_24_]]) {perm = [2, 3, 0, 4, 1]} : (tensor<2x2x256x10x16xf32>) -> tensor<256x10x2x16x2xf32>
// RTR:           [[VAR_26_:%.+]] = "onnx.Reshape"([[VAR_25_]], [[VAR_0_]]) {allowzero = 0 : si64} : (tensor<256x10x2x16x2xf32>, tensor<4xi64>) -> tensor<1x256x20x32xf32>
// D2S:           [[VAR_27_:%.+]] = "onnx.DepthToSpace"([[VAR_23_]]) {blocksize = 2 : si64, mode = "DCR"} : (tensor<1x1024x10x16xf32>) -> tensor<1x256x20x32xf32>
// RTR:           onnx.Return [[VAR_26_]] : tensor<1x256x20x32xf32>
// D2S:           onnx.Return [[VAR_27_]] : tensor<1x256x20x32xf32>
// CHECK:         }
}
...
// RTR-NOT: separator of consecutive DAGs
// RTR-DAG:       [[VAR_48_:%.+]] = "onnx.Reshape"([[VAR_31_]], [[VAR_2_]]) {allowzero = 0 : si64} : (tensor<1x1x18x74xf32>, tensor<5xi64>) -> tensor<1x1x18x74x1xf32>
// RTR-DAG:       [[VAR_49_:%.+]] = "onnx.Reshape"([[VAR_33_]], [[VAR_2_]]) {allowzero = 0 : si64} : (tensor<1x1x18x74xf32>, tensor<5xi64>) -> tensor<1x1x18x74x1xf32>
// RTR-DAG:       [[VAR_50_:%.+]] = "onnx.Reshape"([[VAR_35_]], [[VAR_2_]]) {allowzero = 0 : si64} : (tensor<1x1x18x74xf32>, tensor<5xi64>) -> tensor<1x1x18x74x1xf32>
// RTR-DAG:       [[VAR_51_:%.+]] = "onnx.Reshape"([[VAR_37_]], [[VAR_2_]]) {allowzero = 0 : si64} : (tensor<1x1x18x74xf32>, tensor<5xi64>) -> tensor<1x1x18x74x1xf32>
// RTR-DAG:       [[VAR_52_:%.+]] = "onnx.Reshape"([[VAR_39_]], [[VAR_2_]]) {allowzero = 0 : si64} : (tensor<1x1x18x74xf32>, tensor<5xi64>) -> tensor<1x1x18x74x1xf32>
// RTR-DAG:       [[VAR_53_:%.+]] = "onnx.Reshape"([[VAR_41_]], [[VAR_2_]]) {allowzero = 0 : si64} : (tensor<1x1x18x74xf32>, tensor<5xi64>) -> tensor<1x1x18x74x1xf32>
// RTR-DAG:       [[VAR_54_:%.+]] = "onnx.Reshape"([[VAR_43_]], [[VAR_2_]]) {allowzero = 0 : si64} : (tensor<1x1x18x74xf32>, tensor<5xi64>) -> tensor<1x1x18x74x1xf32>
// RTR-DAG:       [[VAR_55_:%.+]] = "onnx.Reshape"([[VAR_45_]], [[VAR_2_]]) {allowzero = 0 : si64} : (tensor<1x1x18x74xf32>, tensor<5xi64>) -> tensor<1x1x18x74x1xf32>
// RTR-NOT: separator of consecutive DAGs
// RTR-DAG:       [[VAR_56_:%.+]] = "onnx.Reshape"([[VAR_47_]], [[VAR_2_]]) {allowzero = 0 : si64} : (tensor<1x1x18x74xf32>, tensor<5xi64>) -> tensor<1x1x18x74x1xf32>
// RTR-DAG:       [[VAR_57_:%.+]] = "onnx.Concat"([[VAR_48_]], [[VAR_49_]], [[VAR_54_]]) {axis = -1 : si64} : (tensor<1x1x18x74x1xf32>, tensor<1x1x18x74x1xf32>, tensor<1x1x18x74x1xf32>) -> tensor<1x1x18x74x3xf32>
// RTR-DAG:       [[VAR_58_:%.+]] = "onnx.Concat"([[VAR_51_]], [[VAR_52_]], [[VAR_53_]]) {axis = -1 : si64} : (tensor<1x1x18x74x1xf32>, tensor<1x1x18x74x1xf32>, tensor<1x1x18x74x1xf32>) -> tensor<1x1x18x74x3xf32>
// RTR-NOT: separator of consecutive DAGs
// RTR-DAG:       [[VAR_59_:%.+]] = "onnx.Concat"([[VAR_50_]], [[VAR_55_]], [[VAR_56_]]) {axis = -1 : si64} : (tensor<1x1x18x74x1xf32>, tensor<1x1x18x74x1xf32>, tensor<1x1x18x74x1xf32>) -> tensor<1x1x18x74x3xf32>
// RTR-DAG:       [[VAR_60_:%.+]] = "onnx.Reshape"([[VAR_57_]], [[VAR_1_]]) {allowzero = 0 : si64} : (tensor<1x1x18x74x3xf32>, tensor<5xi64>) -> tensor<1x1x18x1x222xf32>
// RTR-DAG:       [[VAR_61_:%.+]] = "onnx.Reshape"([[VAR_58_]], [[VAR_1_]]) {allowzero = 0 : si64} : (tensor<1x1x18x74x3xf32>, tensor<5xi64>) -> tensor<1x1x18x1x222xf32>
// RTR:           [[VAR_62_:%.+]] = "onnx.Reshape"([[VAR_59_]], [[VAR_1_]]) {allowzero = 0 : si64} : (tensor<1x1x18x74x3xf32>, tensor<5xi64>) -> tensor<1x1x18x1x222xf32>
// RTR:           [[VAR_63_:%.+]] = "onnx.Concat"([[VAR_60_]], [[VAR_61_]], [[VAR_62_]]) {axis = -2 : si64} : (tensor<1x1x18x1x222xf32>, tensor<1x1x18x1x222xf32>, tensor<1x1x18x1x222xf32>) -> tensor<1x1x18x3x222xf32>
// RTR:           [[VAR_64_:%.+]] = "onnx.Reshape"([[VAR_63_]], [[VAR_0_]]) {allowzero = 0 : si64} : (tensor<1x1x18x3x222xf32>, tensor<4xi64>) -> tensor<1x1x54x222xf32>
// D2S:           [[VAR_65_:%.+]] = "onnx.Concat"([[VAR_31_]], [[VAR_33_]], [[VAR_43_]], [[VAR_37_]], [[VAR_39_]], [[VAR_41_]], [[VAR_35_]], [[VAR_45_]], [[VAR_47_]]) {axis = 1 : si64} : (tensor<1x1x18x74xf32>, tensor<1x1x18x74xf32>, tensor<1x1x18x74xf32>, tensor<1x1x18x74xf32>, tensor<1x1x18x74xf32>, tensor<1x1x18x74xf32>, tensor<1x1x18x74xf32>, tensor<1x1x18x74xf32>, tensor<1x1x18x74xf32>) -> tensor<1x9x18x74xf32>
// D2S:           [[VAR_66_:%.+]] = "onnx.DepthToSpace"([[VAR_65_]]) {blocksize = 3 : si64, mode = "DCR"} : (tensor<1x9x18x74xf32>) -> tensor<1x1x54x222xf32>
// RTR:           onnx.Return [[VAR_64_]] : tensor<1x1x54x222xf32>
// D2S:           onnx.Return [[VAR_66_]] : tensor<1x1x54x222xf32>
// CHECK:         }
}
...
// CHECK:           [[VAR_7_:%.+]] = "onnx.Transpose"([[VAR_6_]]) {perm = [1, 0, 2, 3]} : (tensor<1x1x4x16xf32>) -> tensor<1x1x4x16xf32>
// CHECK:           [[VAR_8_:%.+]] = "onnx.Conv"([[PARAM_0_]], [[VAR_7_]], [[VAR_2_]]) {auto_pad = "NOTSET", dilations = [1, 1], group = 1 : si64, kernel_shape = [4, 16], pads = [2, 14, 3, 15], strides = [1, 1]} : (tensor<1x1x12x44xf32>, tensor<1x1x4x16xf32>, tensor<1xf32>) -> tensor<1x1x14x58xf32>
// CHECK:           [[VAR_9_:%.+]] = "onnx.LeakyRelu"([[VAR_8_]]) {alpha = 1.000000e-01 : f32} : (tensor<1x1x14x58xf32>) -> tensor<1x1x14x58xf32>
// CHECK:           onnx.Return [[VAR_9_]] : tensor<1x1x14x58xf32>
// CHECK:         }
}
...
// CHECK:           [[VAR_7_:%.+]] = "onnx.Transpose"([[VAR_6_]]) {perm = [1, 0, 2, 3]} : (tensor<1x1x4x16xf32>) -> tensor<1x1x4x16xf32>
// CHECK:           [[VAR_8_:%.+]] = "onnx.Conv"([[PARAM_0_]], [[VAR_7_]], [[VAR_2_]]) {auto_pad = "NOTSET", dilations = [1, 1], group = 1 : si64, kernel_shape = [4, 16], pads = [2, 14, 3, 15], strides = [1, 1]} : (tensor<1x1x12x44xf32>, tensor<1x1x4x16xf32>, tensor<1xf32>) -> tensor<1x1x14x58xf32>
// CHECK:           [[VAR_9_:%.+]] = "onnx.LeakyRelu"([[VAR_8_]]) {alpha = 0.00999999977 : f32} : (tensor<1x1x14x58xf32>) -> tensor<1x1x14x58xf32>
// CHECK:           onnx.Return [[VAR_9_]] : tensor<1x1x14x58xf32>
// CHECK:         }
}
...
// The kernel_shape attribute is optional on ConvTranspose; when it is omitted
// it must be derived from the weight tensor's spatial dims so the phased-conv
// decomposition still matches.
func.func @test_convtrans_4phase_no_kernel_shape(%arg0: tensor<1x80x40x40xf32>, %arg1: tensor<80x40x2x2xf32>, %arg2: tensor<40xf32>) -> tensor<1x40x80x80xf32> {
  %1 = "onnx.ConvTranspose"(%arg0, %arg1, %arg2) {auto_pad = "NOTSET", dilations = [1, 1], group = 1 : si64, output_padding = [0, 0], pads = [0, 0, 0, 0], strides = [2, 2]} : (tensor<1x80x40x40xf32>, tensor<80x40x2x2xf32>, tensor<40xf32>) -> tensor<1x40x80x80xf32>
  onnx.Return %1 : tensor<1x40x80x80xf32>

// CHECK-LABEL:  func.func @test_convtrans_4phase_no_kernel_shape
// CHECK-NOT:       onnx.ConvTranspose
// CHECK:           [[CONV:%.+]] = "onnx.Conv"({{.*}}) {auto_pad = "NOTSET", dilations = [1, 1], group = 1 : si64, kernel_shape = [1, 1], pads = [0, 0, 0, 0], strides = [1, 1]} : (tensor<1x80x40x40xf32>, tensor<160x80x1x1xf32>, tensor<160xf32>) -> tensor<1x160x40x40xf32>
// RTR:             [[RESHAPE_0:%.+]] = "onnx.Reshape"([[CONV]], {{.*}}) {allowzero = 0 : si64} : (tensor<1x160x40x40xf32>, tensor<5xi64>) -> tensor<2x2x40x40x40xf32>
// RTR:             [[TRANSPOSE:%.+]] = "onnx.Transpose"([[RESHAPE_0]]) {perm = [2, 3, 0, 4, 1]} : (tensor<2x2x40x40x40xf32>) -> tensor<40x40x2x40x2xf32>
// RTR:             [[RESHAPE_1:%.+]] = "onnx.Reshape"([[TRANSPOSE]], {{.*}}) {allowzero = 0 : si64} : (tensor<40x40x2x40x2xf32>, tensor<4xi64>) -> tensor<1x40x80x80xf32>
// RTR:             onnx.Return [[RESHAPE_1]] : tensor<1x40x80x80xf32>
// D2S:             [[D2S:%.+]] = "onnx.DepthToSpace"([[CONV]]) {blocksize = 2 : si64, mode = "DCR"} : (tensor<1x160x40x40xf32>) -> tensor<1x40x80x80xf32>
// D2S:             onnx.Return [[D2S]] : tensor<1x40x80x80xf32>
}
