...
// CHECK-LABEL:   func.func @test_convtrans_stride_2_kernel_shape_8_unsupported(
// CHECK-SAME:                                                                  %[[VAL_0:.*]]: tensor<1x64x200xf32>,
// CHECK-SAME:                                                                  %[[VAL_1:.*]]: tensor<64x24x8xf32>) -> tensor<1x24x404xf32> {
// CHECK:           %[[VAL_2:.*]] = onnx.Constant dense<2.000000e-02> : tensor<24xf32>
// CHECK:           %[[VAL_3:.*]] = "onnx.ConvTranspose"(%[[VAL_0]], %[[VAL_1]], %[[VAL_2]]) {auto_pad = "NOTSET", dilations = [1], group = 1 : si64, kernel_shape = [8], pads = [1, 1], strides = [2]} : (tensor<1x64x200xf32>, tensor<64x24x8xf32>, tensor<24xf32>) -> tensor<1x24x404xf32>
// CHECK:           onnx.Return %[[VAL_3]] : tensor<1x24x404xf32>
// CHECK:         }
...
// CHECK-LABEL:   func.func @test_convtrans_stride_2_dilation2(
// CHECK-SAME:                                                 %[[VAL_0:.*]]: tensor<1x64x200xf32>,
// CHECK-SAME:                                                 %[[VAL_1:.*]]: tensor<64x24x4xf32>) -> tensor<1x24x403xf32> {
// CHECK:           %[[VAL_2:.*]] = onnx.Constant dense<2.000000e-02> : tensor<24xf32>
// CHECK:           %[[VAL_3:.*]] = "onnx.ConvTranspose"(%[[VAL_0]], %[[VAL_1]], %[[VAL_2]]) {auto_pad = "NOTSET", dilations = [2], group = 1 : si64, kernel_shape = [4], pads = [1, 1], strides = [2]} : (tensor<1x64x200xf32>, tensor<64x24x4xf32>, tensor<24xf32>) -> tensor<1x24x403xf32>
// CHECK:           onnx.Return %[[VAL_3]] : tensor<1x24x403xf32>
// CHECK:         }
