...
void SimplifyShapeRelatedOpsPass::topDownShapeSimplification(
  ...
  if (onnx_mlir::isSliceCanonicalizationEnabled()) {
    ONNXSliceOp::getCanonicalizationPatterns(patterns, context);
    ONNXTileOp::getCanonicalizationPatterns(patterns, context);
    ONNXConcatOp::getCanonicalizationPatterns(patterns, context);
  }
