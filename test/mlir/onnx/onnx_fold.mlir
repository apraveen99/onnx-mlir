...
// CHECK-DAG:       [[STARTS_:%.+]] = onnx.Constant dense<-1> : tensor<1xi64>
// CHECK-DAG:       [[ENDS_:%.+]] = onnx.Constant dense<-9223372036854775807> : tensor<1xi64>
// CHECK-DAG:       [[AXES_:%.+]] = onnx.Constant dense<0> : tensor<1xi64>
// CHECK:           [[VAR_3_:%.+]] = "onnx.Slice"([[PARAM_0_]], [[STARTS_]], [[ENDS_]], [[AXES_]], [[STARTS_]]) {onnx_node_name = "/Slice"} : (tensor<3x2xi64>, tensor<1xi64>, tensor<1xi64>, tensor<1xi64>, tensor<1xi64>) -> tensor<3x2xi64>
