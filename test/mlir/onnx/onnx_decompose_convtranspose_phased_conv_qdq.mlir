...
// CHECK:           %[[VAL_11:.*]] = "onnx.DequantizeLinear"(%[[VAL_10]], %[[VAL_9]], %[[VAL_7]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1xi8>, tensor<f32>, tensor<i8>) -> tensor<1xf32>
// CHECK:           %[[VAL_12:.*]] = "onnx.QuantizeLinear"(%[[VAL_0]], %[[VAL_5]], %[[VAL_7]]) {axis = 1 : si64, block_size = 0 : si64, output_dtype = 0 : si64, saturate = 1 : si64} : (tensor<1x1x12x44xf32>, tensor<f32>, tensor<i8>) -> tensor<1x1x12x44xi8>
// CHECK:           %[[VAL_13:.*]] = "onnx.DequantizeLinear"(%[[VAL_12]], %[[VAL_5]], %[[VAL_7]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x12x44xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x12x44xf32>
...
// CHECK:           %[[VAL_19:.*]] = "onnx.DequantizeLinear"(%[[VAL_18]], %[[VAL_6]], %[[VAL_7]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x4x16xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x4x16xf32>
...
// CHECK:           %[[VAL_21:.*]] = "onnx.QuantizeLinear"(%[[VAL_20]], %[[VAL_4]], %[[VAL_7]]) {axis = 1 : si64, block_size = 0 : si64, output_dtype = 0 : si64, saturate = 1 : si64} : (tensor<1x1x13x57xf32>, tensor<f32>, tensor<i8>) -> tensor<1x1x13x57xi8>
// CHECK:           %[[VAL_22:.*]] = "onnx.DequantizeLinear"(%[[VAL_21]], %[[VAL_4]], %[[VAL_7]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x13x57xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x13x57xf32>
...
// CHECK:           %[[VAL_3:.*]] = onnx.Constant dense<5> : tensor<2xi64>
// CHECK:           %[[VAL_4:.*]] = onnx.Constant dense<1> : tensor<2xi64>
// CHECK:           %[[VAL_5:.*]] = onnx.Constant dense<[4, 5]> : tensor<2xi64>
// CHECK:           %[[VAL_6:.*]] = onnx.Constant dense<[0, 1]> : tensor<2xi64>
// CHECK:           %[[VAL_7:.*]] = onnx.Constant dense<[5, 4]> : tensor<2xi64>
// CHECK:           %[[VAL_8:.*]] = onnx.Constant dense<[1, 0]> : tensor<2xi64>
// CHECK:           %[[VAL_9:.*]] = onnx.Constant dense<4> : tensor<2xi64>
...
// CHECK:           %[[VAL_13:.*]] = "onnx.NoValue"() {value} : () -> none
// CHECK:           %[[VAL_14:.*]] = onnx.Constant dense<0> : tensor<i8>
// CHECK:           %[[VAL_15:.*]] = onnx.Constant dense<[0, 0, 0, 0, 0, 0, 1, 1]> : tensor<8xi64>
// CHECK:           %[[VAL_16:.*]] = onnx.Constant dense<3> : tensor<3xi64>
// CHECK:           %[[VAL_17:.*]] = onnx.Constant dense<5.000000e-01> : tensor<f32>
// CHECK:           %[[VAL_18:.*]] = onnx.Constant dense<1.000000e+00> : tensor<f32>
// CHECK:           %[[VAL_19:.*]] = onnx.Constant dense<1.22070313E-4> : tensor<f32>
// CHECK:           %[[VAL_20:.*]] = onnx.Constant dense<2> : tensor<i8>
// CHECK:           %[[VAL_21:.*]] = onnx.Constant dense<2> : tensor<128x32x3x3xi8>
// CHECK:           %[[VAL_22:.*]] = onnx.Constant dense<3.125000e-02> : tensor<f32>
// CHECK:           %[[VAL_23:.*]] = onnx.Constant dense<2> : tensor<32xi8>
// CHECK:           %[[VAL_24:.*]] = "onnx.DequantizeLinear"(%[[VAL_23]], %[[VAL_22]], %[[VAL_20]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<32xi8>, tensor<f32>, tensor<i8>) -> tensor<32xf32>
// CHECK:           %[[VAL_25:.*]] = "onnx.QuantizeLinear"(%[[VAL_0]], %[[VAL_18]], %[[VAL_20]]) {axis = 1 : si64, block_size = 0 : si64, output_dtype = 0 : si64, saturate = 1 : si64} : (tensor<1x128x10x16xf32>, tensor<f32>, tensor<i8>) -> tensor<1x128x10x16xi8>
// CHECK:           %[[VAL_26:.*]] = "onnx.DequantizeLinear"(%[[VAL_25]], %[[VAL_18]], %[[VAL_20]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x128x10x16xi8>, tensor<f32>, tensor<i8>) -> tensor<1x128x10x16xf32>
// CHECK:           %[[VAL_27:.*]] = "onnx.Transpose"(%[[VAL_21]]) {perm = [2, 3, 0, 1]} : (tensor<128x32x3x3xi8>) -> tensor<3x3x128x32xi8>
// CHECK:           %[[VAL_28:.*]] = "onnx.ReverseSequence"(%[[VAL_27]], %[[VAL_16]]) {batch_axis = 1 : si64, time_axis = 0 : si64} : (tensor<3x3x128x32xi8>, tensor<3xi64>) -> tensor<3x3x128x32xi8>
// CHECK:           %[[VAL_29:.*]] = "onnx.ReverseSequence"(%[[VAL_28]], %[[VAL_16]]) {batch_axis = 0 : si64, time_axis = 1 : si64} : (tensor<3x3x128x32xi8>, tensor<3xi64>) -> tensor<3x3x128x32xi8>
// CHECK:           %[[VAL_30:.*]] = "onnx.Transpose"(%[[VAL_29]]) {perm = [2, 3, 0, 1]} : (tensor<3x3x128x32xi8>) -> tensor<128x32x3x3xi8>
// CHECK:           %[[VAL_31:.*]] = "onnx.Transpose"(%[[VAL_30]]) {perm = [1, 0, 2, 3]} : (tensor<128x32x3x3xi8>) -> tensor<32x128x3x3xi8>
// CHECK:           %[[VAL_32:.*]] = "onnx.Pad"(%[[VAL_31]], %[[VAL_15]], %[[VAL_14]], %[[VAL_13]]) {mode = "constant"} : (tensor<32x128x3x3xi8>, tensor<8xi64>, tensor<i8>, none) -> tensor<32x128x4x4xi8>
// CHECK:           %[[VAL_33:.*]] = "onnx.Slice"(%[[VAL_32]], %[[VAL_10]], %[[VAL_9]], %[[VAL_12]], %[[VAL_11]]) : (tensor<32x128x4x4xi8>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>) -> tensor<32x128x2x2xi8>
// CHECK:           %[[VAL_34:.*]] = "onnx.Slice"(%[[VAL_32]], %[[VAL_8]], %[[VAL_7]], %[[VAL_12]], %[[VAL_11]]) : (tensor<32x128x4x4xi8>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>) -> tensor<32x128x2x2xi8>
// CHECK:           %[[VAL_35:.*]] = "onnx.Slice"(%[[VAL_32]], %[[VAL_6]], %[[VAL_5]], %[[VAL_12]], %[[VAL_11]]) : (tensor<32x128x4x4xi8>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>) -> tensor<32x128x2x2xi8>
// CHECK:           %[[VAL_36:.*]] = "onnx.Slice"(%[[VAL_32]], %[[VAL_4]], %[[VAL_3]], %[[VAL_12]], %[[VAL_11]]) : (tensor<32x128x4x4xi8>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>) -> tensor<32x128x2x2xi8>
// CHECK:           %[[VAL_37:.*]] = "onnx.DequantizeLinear"(%[[VAL_36]], %[[VAL_19]], %[[VAL_20]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<32x128x2x2xi8>, tensor<f32>, tensor<i8>) -> tensor<32x128x2x2xf32>
// CHECK:           %[[VAL_38:.*]] = "onnx.Conv"(%[[VAL_26]], %[[VAL_37]], %[[VAL_24]]) {auto_pad = "NOTSET", dilations = [1, 1], group = 1 : si64, kernel_shape = [2, 2], pads = [0, 0, 1, 1], strides = [1, 1]} : (tensor<1x128x10x16xf32>, tensor<32x128x2x2xf32>, tensor<32xf32>) -> tensor<1x32x10x16xf32>
// CHECK:           %[[VAL_39:.*]] = "onnx.DequantizeLinear"(%[[VAL_33]], %[[VAL_19]], %[[VAL_20]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<32x128x2x2xi8>, tensor<f32>, tensor<i8>) -> tensor<32x128x2x2xf32>
// CHECK:           %[[VAL_40:.*]] = "onnx.Conv"(%[[VAL_26]], %[[VAL_39]], %[[VAL_24]]) {auto_pad = "NOTSET", dilations = [1, 1], group = 1 : si64, kernel_shape = [2, 2], pads = [1, 1, 0, 0], strides = [1, 1]} : (tensor<1x128x10x16xf32>, tensor<32x128x2x2xf32>, tensor<32xf32>) -> tensor<1x32x10x16xf32>
// CHECK:           %[[VAL_41:.*]] = "onnx.DequantizeLinear"(%[[VAL_34]], %[[VAL_19]], %[[VAL_20]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<32x128x2x2xi8>, tensor<f32>, tensor<i8>) -> tensor<32x128x2x2xf32>
// CHECK:           %[[VAL_42:.*]] = "onnx.Conv"(%[[VAL_26]], %[[VAL_41]], %[[VAL_24]]) {auto_pad = "NOTSET", dilations = [1, 1], group = 1 : si64, kernel_shape = [2, 2], pads = [0, 1, 1, 0], strides = [1, 1]} : (tensor<1x128x10x16xf32>, tensor<32x128x2x2xf32>, tensor<32xf32>) -> tensor<1x32x10x16xf32>
// CHECK:           %[[VAL_43:.*]] = "onnx.DequantizeLinear"(%[[VAL_35]], %[[VAL_19]], %[[VAL_20]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<32x128x2x2xi8>, tensor<f32>, tensor<i8>) -> tensor<32x128x2x2xf32>
// CHECK:           %[[VAL_44:.*]] = "onnx.Conv"(%[[VAL_26]], %[[VAL_43]], %[[VAL_24]]) {auto_pad = "NOTSET", dilations = [1, 1], group = 1 : si64, kernel_shape = [2, 2], pads = [1, 0, 0, 1], strides = [1, 1]} : (tensor<1x128x10x16xf32>, tensor<32x128x2x2xf32>, tensor<32xf32>) -> tensor<1x32x10x16xf32>
// CHECK:           %[[VAL_45:.*]] = "onnx.Concat"(%[[VAL_40]], %[[VAL_44]], %[[VAL_42]], %[[VAL_38]]) {axis = 1 : si64} : (tensor<1x32x10x16xf32>, tensor<1x32x10x16xf32>, tensor<1x32x10x16xf32>, tensor<1x32x10x16xf32>) -> tensor<1x128x10x16xf32>
// CHECK:           %[[VAL_46:.*]] = "onnx.Reshape"(%[[VAL_45]], %[[VAL_2]]) {allowzero = 0 : si64} : (tensor<1x128x10x16xf32>, tensor<5xi64>) -> tensor<2x2x32x10x16xf32>
// CHECK:           %[[VAL_47:.*]] = "onnx.Transpose"(%[[VAL_46]]) {perm = [2, 3, 0, 4, 1]} : (tensor<2x2x32x10x16xf32>) -> tensor<32x10x2x16x2xf32>
// CHECK:           %[[VAL_48:.*]] = "onnx.Reshape"(%[[VAL_47]], %[[VAL_1]]) {allowzero = 0 : si64} : (tensor<32x10x2x16x2xf32>, tensor<4xi64>) -> tensor<1x32x20x32xf32>
// CHECK:           %[[VAL_49:.*]] = "onnx.QuantizeLinear"(%[[VAL_48]], %[[VAL_17]], %[[VAL_20]]) {axis = 1 : si64, block_size = 0 : si64, output_dtype = 0 : si64, saturate = 1 : si64} : (tensor<1x32x20x32xf32>, tensor<f32>, tensor<i8>) -> tensor<1x32x20x32xi8>
// CHECK:           %[[VAL_50:.*]] = "onnx.DequantizeLinear"(%[[VAL_49]], %[[VAL_17]], %[[VAL_20]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x32x20x32xi8>, tensor<f32>, tensor<i8>) -> tensor<1x32x20x32xf32>
// CHECK:           onnx.Return %[[VAL_50]] : tensor<1x32x20x32xf32>
// CHECK:         }
...
// CHECK:           %[[VAL_22:.*]] = "onnx.QuantizeLinear"(%[[VAL_21]], %[[VAL_4]], %[[VAL_7]]) {axis = 1 : si64, block_size = 0 : si64, output_dtype = 0 : si64, saturate = 1 : si64} : (tensor<1x1x13x57xf32>, tensor<f32>, tensor<i8>) -> tensor<1x1x13x57xi8>
// CHECK:           %[[VAL_23:.*]] = "onnx.DequantizeLinear"(%[[VAL_22]], %[[VAL_4]], %[[VAL_7]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x13x57xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x13x57xf32>
...
// CHECK:           %[[VAL_24:.*]] = "onnx.QuantizeLinear"(%[[VAL_23]], %[[VAL_4]], %[[VAL_7]]) {axis = 1 : si64, block_size = 0 : si64, output_dtype = 0 : si64, saturate = 1 : si64} : (tensor<1x1x13x57xf32>, tensor<f32>, tensor<i8>) -> tensor<1x1x13x57xi8>
// CHECK:           %[[VAL_25:.*]] = "onnx.DequantizeLinear"(%[[VAL_24]], %[[VAL_4]], %[[VAL_7]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x13x57xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x13x57xf32>
...
// CHECK:           %[[VAL_31:.*]] = "onnx.DequantizeLinear"(%[[VAL_30]], %[[VAL_29]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1xi8>, tensor<f32>, tensor<i8>) -> tensor<1xf32>
// CHECK:           %[[VAL_32:.*]] = "onnx.QuantizeLinear"(%[[VAL_0]], %[[VAL_25]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64, output_dtype = 0 : si64, saturate = 1 : si64} : (tensor<1x1x18x74xf32>, tensor<f32>, tensor<i8>) -> tensor<1x1x18x74xi8>
// CHECK:           %[[VAL_33:.*]] = "onnx.DequantizeLinear"(%[[VAL_32]], %[[VAL_25]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x18x74xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x18x74xf32>
...
// CHECK:           %[[VAL_48:.*]] = "onnx.DequantizeLinear"(%[[VAL_47]], %[[VAL_26]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x1x1xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x1x1xf32>
...
// CHECK:           %[[VAL_50:.*]] = "onnx.DequantizeLinear"(%[[VAL_44]], %[[VAL_26]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x1x1xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x1x1xf32>
...
// CHECK:           %[[VAL_52:.*]] = "onnx.DequantizeLinear"(%[[VAL_45]], %[[VAL_26]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x1x1xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x1x1xf32>
...
// CHECK:           %[[VAL_54:.*]] = "onnx.DequantizeLinear"(%[[VAL_46]], %[[VAL_26]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x1x1xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x1x1xf32>
...
// CHECK:           %[[VAL_56:.*]] = "onnx.DequantizeLinear"(%[[VAL_43]], %[[VAL_26]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x1x1xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x1x1xf32>
...
// CHECK:           %[[VAL_58:.*]] = "onnx.DequantizeLinear"(%[[VAL_40]], %[[VAL_26]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x1x1xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x1x1xf32>
...
// CHECK:           %[[VAL_60:.*]] = "onnx.DequantizeLinear"(%[[VAL_41]], %[[VAL_26]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x1x1xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x1x1xf32>
...
// CHECK:           %[[VAL_62:.*]] = "onnx.DequantizeLinear"(%[[VAL_42]], %[[VAL_26]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x1x1xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x1x1xf32>
...
// CHECK:           %[[VAL_64:.*]] = "onnx.DequantizeLinear"(%[[VAL_39]], %[[VAL_26]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x1x1xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x1x1xf32>
...
// CHECK:           %[[VAL_83:.*]] = "onnx.QuantizeLinear"(%[[VAL_82]], %[[VAL_24]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64, output_dtype = 0 : si64, saturate = 1 : si64} : (tensor<1x1x54x222xf32>, tensor<f32>, tensor<i8>) -> tensor<1x1x54x222xi8>
// CHECK:           %[[VAL_84:.*]] = "onnx.DequantizeLinear"(%[[VAL_83]], %[[VAL_24]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x54x222xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x54x222xf32>
...
// CHECK:           %[[VAL_51:.*]] = "onnx.DequantizeLinear"(%[[VAL_44]], %[[VAL_26]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x1x1xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x1x1xf32>
...
// CHECK:           %[[VAL_54:.*]] = "onnx.DequantizeLinear"(%[[VAL_45]], %[[VAL_26]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x1x1xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x1x1xf32>
// CHECK:           %[[VAL_55:.*]] = "onnx.Conv"(%[[VAL_33]], %[[VAL_54]], %[[VAL_31]]) {auto_pad = "NOTSET", dilations = [1, 1], group = 1 : si64, kernel_shape = [1, 1], pads = [0, 0, 0, 0], strides = [1, 1]} : (tensor<1x1x18x74xf32>, tensor<1x1x1x1xf32>, tensor<1xf32>) -> tensor<1x1x18x74xf32>
// CHECK:           %[[VAL_56:.*]] = "onnx.Relu"(%[[VAL_55]]) : (tensor<1x1x18x74xf32>) -> tensor<1x1x18x74xf32>
// CHECK:           %[[VAL_57:.*]] = "onnx.DequantizeLinear"(%[[VAL_46]], %[[VAL_26]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x1x1xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x1x1xf32>
...
// CHECK:           %[[VAL_60:.*]] = "onnx.DequantizeLinear"(%[[VAL_43]], %[[VAL_26]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x1x1xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x1x1xf32>
// CHECK:           %[[VAL_61:.*]] = "onnx.Conv"(%[[VAL_33]], %[[VAL_60]], %[[VAL_31]]) {auto_pad = "NOTSET", dilations = [1, 1], group = 1 : si64, kernel_shape = [1, 1], pads = [0, 0, 0, 0], strides = [1, 1]} : (tensor<1x1x18x74xf32>, tensor<1x1x1x1xf32>, tensor<1xf32>) -> tensor<1x1x18x74xf32>
// CHECK:           %[[VAL_62:.*]] = "onnx.Relu"(%[[VAL_61]]) : (tensor<1x1x18x74xf32>) -> tensor<1x1x18x74xf32>
// CHECK:           %[[VAL_63:.*]] = "onnx.DequantizeLinear"(%[[VAL_40]], %[[VAL_26]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x1x1xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x1x1xf32>
...
// CHECK:           %[[VAL_66:.*]] = "onnx.DequantizeLinear"(%[[VAL_41]], %[[VAL_26]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x1x1xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x1x1xf32>
...
// CHECK:           %[[VAL_69:.*]] = "onnx.DequantizeLinear"(%[[VAL_42]], %[[VAL_26]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x1x1xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x1x1xf32>
...
// CHECK:           %[[VAL_72:.*]] = "onnx.DequantizeLinear"(%[[VAL_39]], %[[VAL_26]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x1x1xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x1x1xf32>
...
// CHECK:           %[[VAL_92:.*]] = "onnx.QuantizeLinear"(%[[VAL_91]], %[[VAL_24]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64, output_dtype = 0 : si64, saturate = 1 : si64} : (tensor<1x1x54x222xf32>, tensor<f32>, tensor<i8>) -> tensor<1x1x54x222xi8>
// CHECK:           %[[VAL_93:.*]] = "onnx.DequantizeLinear"(%[[VAL_92]], %[[VAL_24]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x54x222xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x54x222xf32>
...
// CHECK:           %[[VAL_48:.*]] = "onnx.DequantizeLinear"(%[[VAL_47]], %[[VAL_26]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x1x1xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x1x1xf32>
// CHECK:           %[[VAL_49:.*]] = "onnx.Conv"(%[[VAL_33]], %[[VAL_48]], %[[VAL_31]]) {auto_pad = "NOTSET", dilations = [1, 1], group = 1 : si64, kernel_shape = [1, 1], pads = [0, 0, 0, 0], strides = [1, 1]} : (tensor<1x1x18x74xf32>, tensor<1x1x1x1xf32>, tensor<1xf32>) -> tensor<1x1x18x74xf32>
// CHECK:           %[[VAL_50:.*]] = "onnx.QuantizeLinear"(%[[VAL_49]], %[[VAL_24]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64, output_dtype = 0 : si64, saturate = 1 : si64} : (tensor<1x1x18x74xf32>, tensor<f32>, tensor<i8>) -> tensor<1x1x18x74xi8>
// CHECK:           %[[VAL_51:.*]] = "onnx.DequantizeLinear"(%[[VAL_50]], %[[VAL_24]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x18x74xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x18x74xf32>
// CHECK:           %[[VAL_52:.*]] = "onnx.Relu"(%[[VAL_51]]) : (tensor<1x1x18x74xf32>) -> tensor<1x1x18x74xf32>
// CHECK:           %[[VAL_53:.*]] = "onnx.DequantizeLinear"(%[[VAL_44]], %[[VAL_26]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x1x1xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x1x1xf32>
...
// CHECK:           %[[VAL_55:.*]] = "onnx.QuantizeLinear"(%[[VAL_54]], %[[VAL_24]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64, output_dtype = 0 : si64, saturate = 1 : si64} : (tensor<1x1x18x74xf32>, tensor<f32>, tensor<i8>) -> tensor<1x1x18x74xi8>
// CHECK:           %[[VAL_56:.*]] = "onnx.DequantizeLinear"(%[[VAL_55]], %[[VAL_24]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x18x74xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x18x74xf32>
// CHECK:           %[[VAL_57:.*]] = "onnx.Relu"(%[[VAL_56]]) : (tensor<1x1x18x74xf32>) -> tensor<1x1x18x74xf32>
// CHECK:           %[[VAL_58:.*]] = "onnx.DequantizeLinear"(%[[VAL_45]], %[[VAL_26]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x1x1xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x1x1xf32>
// CHECK:           %[[VAL_59:.*]] = "onnx.Conv"(%[[VAL_33]], %[[VAL_58]], %[[VAL_31]]) {auto_pad = "NOTSET", dilations = [1, 1], group = 1 : si64, kernel_shape = [1, 1], pads = [0, 0, 0, 0], strides = [1, 1]} : (tensor<1x1x18x74xf32>, tensor<1x1x1x1xf32>, tensor<1xf32>) -> tensor<1x1x18x74xf32>
// CHECK:           %[[VAL_60:.*]] = "onnx.QuantizeLinear"(%[[VAL_59]], %[[VAL_24]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64, output_dtype = 0 : si64, saturate = 1 : si64} : (tensor<1x1x18x74xf32>, tensor<f32>, tensor<i8>) -> tensor<1x1x18x74xi8>
// CHECK:           %[[VAL_61:.*]] = "onnx.DequantizeLinear"(%[[VAL_60]], %[[VAL_24]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x18x74xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x18x74xf32>
// CHECK:           %[[VAL_62:.*]] = "onnx.Relu"(%[[VAL_61]]) : (tensor<1x1x18x74xf32>) -> tensor<1x1x18x74xf32>
// CHECK:           %[[VAL_63:.*]] = "onnx.DequantizeLinear"(%[[VAL_46]], %[[VAL_26]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x1x1xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x1x1xf32>
// CHECK:           %[[VAL_64:.*]] = "onnx.Conv"(%[[VAL_33]], %[[VAL_63]], %[[VAL_31]]) {auto_pad = "NOTSET", dilations = [1, 1], group = 1 : si64, kernel_shape = [1, 1], pads = [0, 0, 0, 0], strides = [1, 1]} : (tensor<1x1x18x74xf32>, tensor<1x1x1x1xf32>, tensor<1xf32>) -> tensor<1x1x18x74xf32>
// CHECK:           %[[VAL_65:.*]] = "onnx.QuantizeLinear"(%[[VAL_64]], %[[VAL_24]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64, output_dtype = 0 : si64, saturate = 1 : si64} : (tensor<1x1x18x74xf32>, tensor<f32>, tensor<i8>) -> tensor<1x1x18x74xi8>
// CHECK:           %[[VAL_66:.*]] = "onnx.DequantizeLinear"(%[[VAL_65]], %[[VAL_24]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x18x74xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x18x74xf32>
// CHECK:           %[[VAL_67:.*]] = "onnx.Relu"(%[[VAL_66]]) : (tensor<1x1x18x74xf32>) -> tensor<1x1x18x74xf32>
// CHECK:           %[[VAL_68:.*]] = "onnx.DequantizeLinear"(%[[VAL_43]], %[[VAL_26]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x1x1xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x1x1xf32>
...
// CHECK:           %[[VAL_70:.*]] = "onnx.QuantizeLinear"(%[[VAL_69]], %[[VAL_24]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64, output_dtype = 0 : si64, saturate = 1 : si64} : (tensor<1x1x18x74xf32>, tensor<f32>, tensor<i8>) -> tensor<1x1x18x74xi8>
// CHECK:           %[[VAL_71:.*]] = "onnx.DequantizeLinear"(%[[VAL_70]], %[[VAL_24]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x18x74xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x18x74xf32>
// CHECK:           %[[VAL_72:.*]] = "onnx.Relu"(%[[VAL_71]]) : (tensor<1x1x18x74xf32>) -> tensor<1x1x18x74xf32>
// CHECK:           %[[VAL_73:.*]] = "onnx.DequantizeLinear"(%[[VAL_40]], %[[VAL_26]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x1x1xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x1x1xf32>
...
// CHECK:           %[[VAL_75:.*]] = "onnx.QuantizeLinear"(%[[VAL_74]], %[[VAL_24]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64, output_dtype = 0 : si64, saturate = 1 : si64} : (tensor<1x1x18x74xf32>, tensor<f32>, tensor<i8>) -> tensor<1x1x18x74xi8>
// CHECK:           %[[VAL_76:.*]] = "onnx.DequantizeLinear"(%[[VAL_75]], %[[VAL_24]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x18x74xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x18x74xf32>
// CHECK:           %[[VAL_77:.*]] = "onnx.Relu"(%[[VAL_76]]) : (tensor<1x1x18x74xf32>) -> tensor<1x1x18x74xf32>
// CHECK:           %[[VAL_78:.*]] = "onnx.DequantizeLinear"(%[[VAL_41]], %[[VAL_26]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x1x1xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x1x1xf32>
...
// CHECK:           %[[VAL_80:.*]] = "onnx.QuantizeLinear"(%[[VAL_79]], %[[VAL_24]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64, output_dtype = 0 : si64, saturate = 1 : si64} : (tensor<1x1x18x74xf32>, tensor<f32>, tensor<i8>) -> tensor<1x1x18x74xi8>
// CHECK:           %[[VAL_81:.*]] = "onnx.DequantizeLinear"(%[[VAL_80]], %[[VAL_24]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x18x74xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x18x74xf32>
// CHECK:           %[[VAL_82:.*]] = "onnx.Relu"(%[[VAL_81]]) : (tensor<1x1x18x74xf32>) -> tensor<1x1x18x74xf32>
// CHECK:           %[[VAL_83:.*]] = "onnx.DequantizeLinear"(%[[VAL_42]], %[[VAL_26]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x1x1xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x1x1xf32>
...
// CHECK:           %[[VAL_85:.*]] = "onnx.QuantizeLinear"(%[[VAL_84]], %[[VAL_24]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64, output_dtype = 0 : si64, saturate = 1 : si64} : (tensor<1x1x18x74xf32>, tensor<f32>, tensor<i8>) -> tensor<1x1x18x74xi8>
// CHECK:           %[[VAL_86:.*]] = "onnx.DequantizeLinear"(%[[VAL_85]], %[[VAL_24]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x18x74xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x18x74xf32>
// CHECK:           %[[VAL_87:.*]] = "onnx.Relu"(%[[VAL_86]]) : (tensor<1x1x18x74xf32>) -> tensor<1x1x18x74xf32>
// CHECK:           %[[VAL_88:.*]] = "onnx.DequantizeLinear"(%[[VAL_39]], %[[VAL_26]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x1x1xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x1x1xf32>
...
// CHECK:           %[[VAL_90:.*]] = "onnx.QuantizeLinear"(%[[VAL_89]], %[[VAL_24]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64, output_dtype = 0 : si64, saturate = 1 : si64} : (tensor<1x1x18x74xf32>, tensor<f32>, tensor<i8>) -> tensor<1x1x18x74xi8>
// CHECK:           %[[VAL_91:.*]] = "onnx.DequantizeLinear"(%[[VAL_90]], %[[VAL_24]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x18x74xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x18x74xf32>
...
// CHECK:           %[[VAL_110:.*]] = "onnx.QuantizeLinear"(%[[VAL_109]], %[[VAL_24]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64, output_dtype = 0 : si64, saturate = 1 : si64} : (tensor<1x1x54x222xf32>, tensor<f32>, tensor<i8>) -> tensor<1x1x54x222xi8>
// CHECK:           %[[VAL_111:.*]] = "onnx.DequantizeLinear"(%[[VAL_110]], %[[VAL_24]], %[[VAL_27]]) {axis = 1 : si64, block_size = 0 : si64} : (tensor<1x1x54x222xi8>, tensor<f32>, tensor<i8>) -> tensor<1x1x54x222xf32>
